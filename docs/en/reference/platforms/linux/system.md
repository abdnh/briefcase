...
Briefcase cannot reliably identify *every* Linux vendor. If your Linux distribution isn't being identified (or isn't being identified correctly), please [open a ticket](https://github.com/beeware/briefcase/issues) with the contents of your `/etc/os-release` file.
