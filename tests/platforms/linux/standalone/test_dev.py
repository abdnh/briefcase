...
from briefcase.platforms.linux.standalone import LinuxStandaloneDevCommand


@pytest.fixture
def dev_command(dummy_console, tmp_path):
    command = LinuxStandaloneDevCommand(
...
def test_standalone_dev_starts(dev_command, first_app_config, tmp_path, default_venv):
    """A Linux standalone app can be started in development mode."""
